...
powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-sec-oauth-detail.ps1

php tests/test_domain_review.php

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-sec-oauth-properties.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion-sec-oauth-golden.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }

powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-ion_sec_oauth_index-casebook.ps1
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
